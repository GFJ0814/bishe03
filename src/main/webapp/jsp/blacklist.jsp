...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">黑名单管理</h1>
                    <h1 class="page-subhead-line">管理所有黑名单用户信息</h1>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button class="btn" data-toggle="modal" data-target="#myModal1"><i class="glyphicon glyphicon-plus" ></i>单外提报</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>存在网贷未还记录</td>
                                                    <td>
                                                        <button type="button" class="btn btn-xs btn-info" >解除黑名单</button>

                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>张启文</td>
                                                    <td>589245199309172346</td>
                                                    <td>13767564532</td>
                                                    <td>工程学院</td>
                                                    <td>工业设计</td>
                                                    <td>20136785</td>

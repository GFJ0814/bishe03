    ...
    <div class="am-container">
        ...
        <div class="am-collapse am-topbar-collapse" id="collapse-head">
            <ul class="am-nav am-nav-pills am-topbar-nav">
                ...
                <li><a href="category.html">一览无余</a></li>
                <li><a href="#">我要报名</a></li>
                <li><a href="profile.html">建言献策</a></li>
                <li><a href="events.html">系统后台</a></li>
            </ul>

            <div class="am-topbar-right">
                <button class="am-btn am-btn-default am-topbar-btn am-btn-sm"><span class="am-icon-pencil"></span><a href="/jsp/register.jsp">注册</a></button>
            </div>

            <div class="am-topbar-right">
                <button class="am-btn am-btn-danger am-topbar-btn am-btn-sm"><span class="am-icon-user"></span><a href="/jsp/index.jsp">登录</a></button>
            </div>
        </div>
    </div>
</header>
